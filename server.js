...
const db = mysql.createConnection(
    ...
    // error is on this page at line 19, need to find the right database
...
const viewAllDepartments = () => {
    ("ALL  DEPARTMENTS", function(err, res) {
        if (err) {
...
const viewAllEmployees = () => {
    ("ALL  EMPLOYEES", function(err, res) {
        if (err) {
            console.log('Something went wrong...');
            console.dir(err);
            return;
...
const addDepartment = () => {
    ("ADD  DEPARTMENT", function(err, res) {
        if (err) {
            console.log('Something went wrong...');
            console.dir(err);
            return;
